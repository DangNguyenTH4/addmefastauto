...
$timeFromCloseToConfirm = 3000 ; khoang thoi gian tu khi click close (X) toi khi click confirm button
...
While $x<20
   ...
   if IsArray($actionBtnPosition) Then
	  ;Click vao nut
	  MouseMove($LEFT_MOUSE, $actionBtnPosition[0]+$foundButtonExtentX,$actionBtnPosition[1]+$foundButtonExtentY)
